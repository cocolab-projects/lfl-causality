...
three_beaker_graph <- accuracy_by_game %>%
  ...
  theme_cowplot() + 
  labs(title = "Student vs Teacher Accuracy", subtitle = "First Iteration", x = "Student Accuracy", y = "Teacher Accuracy", color = "Round") +
...
accuracy_by_game_multi %>%
  ...
  theme_cowplot() + 
  geom_abline(intercept = 0, slope = 1, linetype = "dotted") + 
  labs(title = "Student vs Teacher Accuracy", subtitle = "Second Iteration", x = "Student Accuracy", y = "Teacher Accuracy", color = "Round") + 
  xlim(0, 1.01) + 
  ylim(0, 1.01)
```
...
```{r}
  ggplot(NULL) +
  geom_point(data = accuracy_by_game, mapping = aes(color = "#CC0000", x = student_accuracy, y = explorer_accuracy, shape = factor(round_num))) +
  geom_point(data = accuracy_by_game_multi, mapping = aes(color = "#000099", x = student_accuracy, y = explorer_accuracy, shape = factor(round_num))) +
...
accuracy_by_round %>%
  ...
  geom_errorbar(aes(ymin=ci_low, ymax=ci_up), color="black", width=0.5, position= "dodge", show.legend = FALSE) +
  scale_alpha_manual(values = c("explorer" = 1.0, "student" = 0.4)) +
  guides(fill = FALSE) + 
  theme_cowplot() + 
  labs(title = "Explorer and Student Accuracies across rounds", subtitle = "First Iteration", x = "Round", y = "Mean Accuracy", alpha = "Role")
...
accuracy_by_question_type %>%
  ...
  scale_alpha_manual(values = c("beaker" = 1.0, "reaction" = 0.4)) +
  guides(fill = FALSE) + 
  theme_cowplot() + 
labs(title = "Accuracies across Question Type", subtitle = "First Iteration", x = "Round", y = "Mean Accuracy", alpha = "Question Type")
